...
.controller('DashCtrl', function($scope
  ...
  $scope.showTrocarComida = showTrocarComida
  $scope.showReceberComida = showReceberComida
  $scope.showcdproduto = showcdproduto
...
*/
  ...
  var cardTypes = [
    ...
    { image:  'img/caixa-milho.jpg'},
    { image:  'img/atum.jpg'},
    { image:  'img/danone.jpg'},
  ...
  function showReceberComida() {
    $ionicModal.fromTemplateUrl('templates/modals/receberComida.html', {
      scope: $scope,
      animation: 'animated _zoomOut',
      hideDelay:920
    }).then(function(modal) {
  ...
  function showcdproduto() {
    $ionicModal.fromTemplateUrl('templates/modals/cdproduto.html', {
      scope: $scope,
      animation: 'animated _zoomOut',
      hideDelay:920
    }).then(function(modal) {
  ...
  // showProfile();
  function showdetalheprodutos() {
    $ionicModal.fromTemplateUrl('templates/modals/detalheprodutos.html', {
      scope: $scope,
      animation: 'animated _zoomOut',
      hideDelay:920
    }).then(function(modal) {
      $scope.modalProfile = modal;
      $scope.modalProfile.show();
      $scope.hidedetalheprodutos = function(){
        $scope.modalProfile.hide();
      }
    });
  };
  ...
  function showTrocarComida() {
    $ionicModal.fromTemplateUrl('templates/modals/trocarComida.html', {
      scope: $scope,
      animation: 'slide-in-up',
      hideDelay:920
    }).then(function(modal) {
